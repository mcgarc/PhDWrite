...
The losses due to radiation are almost entirely negligible. Cao et
al.~\cite{L.Cao2013} report a loss of $\alpha_r = \SI{0.43}{\decibel \per \milli
\meter}$, which scales cubcially with the frequency~\cite{81658}. This means we
can expect $\alpha_r \sim 10^{-2}$ at our frequencies.
