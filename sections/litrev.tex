...
after~\cite{Meek2009}, but Andr\'e et al. presented no method of loading their
...
losses~\cite{PhysRevLett.51.1336}. \cm{better to say spin flip??}
...
\myfigref{litrev:fig:trapvariations}. \thesis{I should really show the fields
...
\myeqref{litrev:eqn:bias} showing that trapping closer to the wire requires a
...
acceptance (expand the latter above?)}
