\cm{
  \begin{itemize}
    \item Build on IID
    \item Introduce existing experiment apparatus
    \item Talk about the microwave stuff a bit more
    \item Emphaise magnetically insensetive transitions as justification for
      magnetic trapping
      \item Briefly talk about difficulties of working at 40GHz
  \end{itemize}
}
