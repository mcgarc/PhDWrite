\cm{Have I actually lead the reader to this conclusion?}
...
\thesis{Should replace this paragaph with some COMSOL simulation and further
...
\begin{figure}[ht]
  ...
  \caption{
    ...
    fall. This CAD design was undertaken by Kyle Jarvies.
  }
...
~\myfigref{experiment:fig:ramptraps}. \ph{Details about the chosen example
ramp.}
...
bias fields.
%
\cm{Need to get something in about the higher currents in thicker wires.}
...
\begin{table}
  \centering
  \begin{tabular*}{0.8\textwidth}{| @{\extracolsep{\fill} }  c c c c c c c|}
   \hline
    Axis length  & $h_0$ & $I$  & Bx & By
   & Depth  & $B_0$  \\
    (\si{\centi\metre}) & (\si{\micro\metre}) & (\si{\ampere}) & G & G & 
    (\si{\milli\kelvin}) & (\si{\gauss}) \\
  \hline
    3 & 200 & 3.3 & ?? & ?? & 2.2 & ?? \\
  1 & 100 & 2.2 & ?? & ??& 1.9 & ?? \\
  0.3 & 50 & 1.1 & ?? & ??& 2.9 & ?? \\
 ...
 \hline
\end{tabular*}
  \caption{\cm{Add MTT, U and dimple.} In this table we present a series of trapping stages in the loading
  ...
  stage is shown in \myfigref{experiment:fig:ramptraps}.}
