...
for the smallest CPWs will be $S\sim\SI{1}{\micro\metre}$ \cm{Mike: surely 10um
is the smallest we are fabricating? Cameron: maybe need different values for
different x-sections (or widths with set height?) see above comment from Mike
about more plots}}, with a height of approximately \SI{6}{\micro\metre}
...
waveguide we are using and include that.}
