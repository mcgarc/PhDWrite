...
\begin{figure}[ht]
  \includegraphics[width=\textwidth]{./figs/z_trap_fanouts_inset_scale.png}
  \caption{
...
will be brought in through a nineteen-pin feedthrough \cm{need part details,
5amps < limit from wire thickness...} to power the bias coils and on-chip trapping
wires. These currents will feed onto a holding-chip, which will then connect to
the science-chip via wirebonds. Seperate feedthroughs for the microwaves
(\cm{details}) and U-wire (\cm{details}) feed onto CPWs on the holding-chip and
