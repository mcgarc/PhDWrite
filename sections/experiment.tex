...
\begin{figure}[ht]
  ...
  \caption{
    ...
    fields are linearly ramped from \cm{(Bx, By) =..} to \cm{Bx, By}, reducing the
...
\begin{table}
  \centering
  \begin{tabular*}{0.8\textwidth}{| @{\extracolsep{\fill} }l | c c c c c c c|}
   \hline
    Trap stage & Axis length  & $h_0$ & $I$  & Bx & By & Depth  & $B_0$  \\
    & (\si{\milli\metre}) & (\si{\micro\metre}) & (\si{\ampere}) & G & G & 
    (\si{\milli\kelvin}) & (\si{\gauss}) \\
  \hline
    MTT& N/A & $10^4$  & & N/A & N/A & & 0 \\
    inter-U1 & N/A & & & & & & \\
    inter-U2 & N/A & 400 & & & & & \\
    Z1 & 30 & 400 & 3.3 & ?? & ?? & 1.1 & ?? \\
    Z2 & 30 & 200 & 3.3 & ?? & ?? & 2.2 & ?? \\
