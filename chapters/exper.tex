...
\begin{figure}
  ...
  \caption{The optical (a) and vacuum (b) setup for the spectroscopy
    ...
    installed for the beam experiment, and are only used for the \cm{MOT}
    experiment. The buffer-gas source and \CaF{} beam are shown, similarly to
    \cm{reference earlier figure}. A PMT is mounted above the beam (out of the
...
and position}, focusing onto a photo-multiplier tube (PMT) \cm{in some place}.
