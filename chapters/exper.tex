...
shown in \myfigref{overview:fig:chipchamber}.
...
was not possible due to the unavailability of the the hardware at LCN.  Another
...
shown in \mysubfigref{exper:fig:current}{b}. The dependence of resistance on
...
We saw in section~\ref{theory:trapcool} that the scattering rate for a
...
majority of the light passes through an electo-optic modulator, which is used
...
not installed as switching is not required.
