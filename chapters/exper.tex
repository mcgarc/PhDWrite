...
\begin{figure}
  ...
  \caption{The optical (a) and vacuum (b) setup for the spectroscopy
    ...
    that the AOM and EOM are not installed for the beam experiment, and are
    only used for the \cm{MOT} experiment. The buffer-gas source and \CaF{}
    beam are shown, similarly to \cm{reference earlier figure}. A PMT is
    mounted above the beam (out of the page) as described in the main text.
  }
...
This is achieved using an electro-optic modulator (EOM) \cm{made of something
and tuned to freq}.
%
