...
significantly more strongly \mt{could be more quantitative here,
caluclate $\mu_e*E / (\mu_B * B)$ (comparing electic and magnetic dipole
moments)}
...
illustrated in \myfigref{intro:fig:reicheltrap}, where a two dimensional
...
\mt{
  To my mind, a quadrupole trap means more than just having a field minimum. It describes the shape of the trap. |B| should be linear in the displacement for it to be a quadrupole trap. It might be that that a trap with a zero of field always has that shape, but that isn't obvious to me. 
}
