...
This produces the die with mould as depicted in \mysubfigref{fab:fig:tmep}{b}.
...
\centering
  ...
  \caption{
    ...
    (purple) above the seed layer (colours as in \myfigref{fab:fig:process})
...
\myfigref{fab:fig:tmep} and is also useful for examining the features after
plating.
...
\begin{figure}[h]
  \ph{Example profile of liens with mould}
  \caption{TODO}
...
be able to reach the bottom. This explains the shown in \mysubfigref{fab:fig:exampleprofile}{??}, and so the profilometer will measure the trench as
being below its actual depth. This effect is demonstrated for \ph{the lines
characterisation feature} in \myfigref{fab:fig:exampleprofile}.

\begin{figure}[h]
  \ph{Example profile of mould, where we see that the resolution is limited.
  Also a cartoon of the stylus getting stuck}
  \caption{TODO}
