...
have reported a current density of \SI{6E10}{\ampere\per\meter\squared} in the
trapping wires. For our wires this would require a minimum height on the order
of a micron to carry our trapping currents, much higher than can be achieved
with photolithography techniques.
...
both of these are discussed further in section~\ref{fab:prep}. Some
photoresists require rehydration after exposure, which can take several hours.
...
then passed through the target to induce evaporation of the metal onto the
