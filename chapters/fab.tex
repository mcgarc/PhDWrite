...
The electroplating procedure was initiallly unreliable, but we have developed
...
become detached from the chip, see \mysubfigref{fab:fig:overetch}. This could be due to over-etching, or poor
...
\mysubfigref{design:fig:chipexperiment}{b}. It is helpful when etching to
