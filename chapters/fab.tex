...
{\includegraphics[width=0.8\textwidth]{figs/fab/olddesign/oldchip_present_detail.pdf} };
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \draw [black, line width=0.2em] (0.2,9em) -- node[below,inner
sep=0.1em, font=\footnotesize] {\SI{600}{\micro\meter}} (0.15+0.2,9em);
      \end{scope}
    \end{tikzpicture}
    \caption{}
  \end{subfigure}
...
\myfigref{fab:fig:shadow}. This phenomenom was also noted in
