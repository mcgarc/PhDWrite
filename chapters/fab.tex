...
been invaluable to this project. \cm{move thanks to acks I think...}
...
target. This is illustrated in \cm{\myfigref{fab:fig:eplate}
(a)}. An overview of electroplating can be found in \cm{Ref.\
~\cite{Schlesinger2011}} and a discussion of its use in microfabrication,
including the through-mask method employed here, can be found in \cm{Ref.\
~\cite{Ruythooren_2000}}.
...
\end{equation}
%
where \cm{$F=???$} is the Faraday constant, \ph{other params (including
relevant values for gold}.
%
\begin{equation}
...
\cm{\myfigref{fab:fig:eplate}~(b)}. \cm{And then explain the aparratus...}
