...
long?}. This produces the die with mould as depicted in
...
in the lowest row of \myfigref{fab:fig:tmep} and is also useful for examining
...
\ph{(see next section)}. However it is not possible to profile these with the
stylus profilometer, since the small features where this occur are smaller than
the resolution of the device \ph{(see above)}.

\begin{figure}[h]
  \ph{Comparision of a good and bad mould}
  \caption{TODO}
