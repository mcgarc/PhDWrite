...
\myfigref{design:fig:chipexperiment} was adopted.  informed by existing designs
in the literature~\cite{} and an idea that the traps should 

\begin{figure}[htbp]
\centering
  \ph{Fig of fuse design}
  \caption{}
...
various pitfalls we encounted, point out where limitations of the process have
lead to changes in the design of the chip.
