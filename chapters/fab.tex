...
in some figure above}. Here we manually agitated the electroplating solution
during plating. We were succesful in laying down the larger features such as
the wire bond pads, but sub $~100\si{\micro\meter}$ features could not be seen
after removing the photoresist mould. The results are shown in
...
aggitation in \myfigref{fab:fig:aggandcorr}.

% TODO Add a scale to these figs.
\begin{figure}
  \centering
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figs/fab/eplatetroubleshoot/aggandcorr/manualagg.png}
    \caption{}
  \end{subfigure}
  \hspace{1cm}
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/fab/eplatetroubleshoot/aggandcorr/corrosion.png}
    \caption{}
  \end{subfigure}

  \begin{subfigure}[b]{0.22\textwidth}
    \centering
    \ph{Equalivalent to a for good chip}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.22\textwidth}
    \centering
    \ph{Equalivalent to b for good chip}
    \caption{}
  \end{subfigure}
  \caption{
    ...
    with \cm{1165 remover}. The dies shown in (a) and (b) are different dies
...
\mysubfigref{fab:fig:aggandcorr}{b}, and does not occur when the photoresist
remover is used.
...
damage done to the wirebondpad can be seen in
\mysubfigref{fab:fig:1stgoodplate}{a},
which shows the first design iteration with the plating connector pad.
%This pad was too small to achieve good connection and was made larger in later designs.
On this iteration we were able to electroplate wires with good adhesion across
the chip as shown in \mysubfigref{fab:fig:1stgoodplate}{b}.

\begin{figure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/fab/eplatetroubleshoot/2020-02-20.jpg}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \ph{Profile of this chip (must have files, data on onenote)}
    \caption{}
  \end{subfigure}
  \caption{
    One of the first dies whith successful electroplating across the entire
    substrate. On the top of the die in (a) we can see the dedicated wire bond
    pad (which was not used in this case, as this version was too small for
    good contact with the clip). Damaged caused by attaching the clip to the
    the wire bond pad can be seen on the left of the chip. The gold seed layer
    has been etched, some debris is present on the chip, the cause of which is
    discussed in section~\ref{fab:etch}. Subfigure (b) shows the profile of the
    wires taken with the DektakXT profilometer. This die was plated at
    \SI{15}{\milli\ampere} for \SI{400}{\second}.
  }
  \label{fab:fig:1stgoodplate}
\end{figure}
...
the larger wires were not uniformly plated, with some areas near the edge
