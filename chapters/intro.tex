...
restoring force tha in a pure magnetic trap, and also produces a
...
and in an optical dipole trap and lattice~\cite{Anderegg2019a}. Futher cooling schemes such as
transverse cooling (similar to that seen for \YbF{} in \inlineref{Alauze2021})
and Zeeman-Sisyphys cooling have been demonstrated\cite{Fitch2016,
...
Colelge~\cite{Jurgilas2021, JurgilasPRL_2021}. The thermalisation of molecules
