...
detuned to be blue-detuned \cm{by how much?}. Consider again the example of a
...
to the $F'=0$ state. As explained in \cm{ref Weidelmuller} we will a bright
...
% TODO Here need good cite of Weidmeuller
...
energy than the dark states, and we have a heating effect \cm{cite Mike's 3D
paper}
...
hyperfine state \cm{cite 3D paper and deep cooling paper}

% TODO Cite Molecules cooled belowo DOppler limit, Three dimensional pape
% rand...
...
the procedure described in \cm{magnetic trapping paper}. This transfer is
achieved with optical pumping, where the EOM producing the \pewpew{}{00}
...
$\ket{1}_\text{str}\leftrightarrow\ket{2}_\text{str}$ (\cm{$\omega_0/(2\pi) =
\SI{41}{\giga\hertz}$}) transitions observed in \cm{cite long coherence times
paper}, which we will discuss further in chapter~\ref{mws}.
