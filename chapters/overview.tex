...
\begin{figure}
  \centering
  \includegraphics{figs/overview/cartoon_notext.pdf}
...
\begin{tabular}{llll}
  ...
  \pewpew{}{10} & $X(v=1)$ & $A(v=0)$ & 585 \\ % TODO More decimal places
 \hline
\end{tabular}
\caption{
...
\begin{figure}
  \centering
  \includegraphics{figs/overview/cell.pdf}
  \caption{The buffer gas cell. \He{} and \SFsix flow into the cell. \Ca{}
  atoms are ablated from a target by a Nd:YAG laser. \CaF{} molecules are
...
First, the significant number of photon scatters in the MOT
...
\begin{figure}
  \centering
  \includegraphics[width=0.2\textwidth]{figs/overview/typeII.pdf}
  \caption{
...
hyperfine state~\cite{1367-2630-18-12-123017, PhysRevLett.123.033202}.
...
such as those describedin \cm{section} would be preferable to the electrostatic
traps suggested in \inlineref{Andre2006}. We are now faced with the question of
how exactly we can load molecules from the MTT into the microscopic chip trap.

% TODO The phrasing of this para can be improved
Fortunately this problem has previously been addressed for atom chips. For
example in \inlineref{Ott2001} a similar transport scheme to ours is used to
load an atom chip. Here the authors have used a macroscopic U-trap that is
aligned with the chip to improve alignment of their transport trap and their
chip trap. We propose to do the same thing, with molecules then transferred
between the traps by ramping of the trapping currents in the U-wire and coils.
%
