...
first is the repumping of the vibrational levels. We apply vibrational repumps (\pewpew{}{10}, \pewpew{}{21}
...
\begin{figure}
  ...
  \caption[Hyperfine structe in \CaF{}]{
    Hyperfine structure of \CaF{} ground states. The stretched states
...
each wire segment, and is described in section~\ref{exper:current:drivers}.
Further, this initial design does not incorporate microwave guides. These are to
be installed on a second level, separated from the trapping wires by a thin
...
delivery (detailed in \myfigref{overview:fig:subchip}). Connection is possible
...
chamber, positioned as shown in \myfigref{overview:fig:MTT} and
