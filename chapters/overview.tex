...
\begin{figure}
  ...
  \includegraphics[width=0.8\textwidth]{figs/overview/cartoon.pdf}
    ...
    %\vspace{1cm}
  \caption[\CaF{} source]{
    A schematic of the \CaF{} source, slowing region and MOT chamber.
...
will be discussed further in chapter~\ref{exper}. In the next section, we
...
vacuum Rabi frequency found in section~\ref{theory:cooltrap}. We find this to
