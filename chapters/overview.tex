...
{\includegraphics[width=0.8\textwidth]{figs/overview/apparatus_04_crp.png} };
      ...
      \end{scope}
    \end{tikzpicture}
%    \begin{overpic}[width=0.7\textwidth]{figs/overview/apparatus_04_crp.png}
%      \put(5,15){\small Chip chamber}
%      \put(1,50){\small Tweezer chamber}
%      \put(55,65){\small \Rb{} MOT cell}
%      \put(81, 45){\small Slowing region}
%      \put(60, 5){\small Source}
%      \put(45,23){\vector(0,4){15}}
%      \put(36,19){\small MOT chamber}
%    \end{overpic}
  \caption{
