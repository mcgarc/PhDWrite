...
microwave spectroscopy techniques, for example by being rotated onto an
...
It is possible to create a SSS by two main methods. One method is to implement
...
%
When discussing the SSS, it is useful to introduce the new symbol $\Delta_m$ to
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{figs/squeeze/cat.pdf}
