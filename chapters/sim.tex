...
achieved by compressing the cloud in an optical dipole trap. The
...
%
% TODO Mike crossed this out here. Should be OK because it should probably go
% higher up
% The \CaF{} mass is $m_\text{\CaF{}}=\SI{9.79E-26}{\kilogram}$.
%
...
\centering
  ...
  \end{tikzpicture}
  \caption[Geometry of wire segment]{
...
\centering
  ...
  \caption[Affect of ramp duration on phase-space distribution]{
...
\begin{figure}[tbhp]
\centering
  \scalebox{0.8}{\begin{overpic}[page=1]{figs/sims/phase_matching_grid.pdf}
    \put(0,68){(a)}
    \put(0,44.5){(b)}
    \put(0,21){(c)}
  \end{overpic}}
...
efficiency described by the trajectory simulations. We expect a loading
efficieny of 2\%. This would deliver only 50 molecules into the final trap in
...
clear that this procedure can be used to load a cloud Ongoing efforts to
