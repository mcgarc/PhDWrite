...
(\mysubfigref{sim:fig:mttusim}{f}) it is clear that there is some loss
...
\SI{3}{\milli\meter}. The ramps are summarised in \myfigref{sim:fig:simsum}
and the simulation is presented in \myfigref{sim:fig:uzsim}.
...
\mysubfigref{sim:fig:simsum}{d}). This loss is similar to that of the MTT to
...
\centering
  ...
  \caption{
    ...
    shaded grey (c.f.~\myfigref{sim:fig:simsum}).
  }
  \label{sim:fig:uzsim}
\end{figure}
...
in \mysubfigref{sim:fig:zsim}{e}, the particles are highly localised around
...
\mysubfigref{sim:fig:phasematchinggrid}{c}.
