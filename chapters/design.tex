...
\begin{figure}[htb]
  ...
  \caption{
    ...
    molecules by the methods described in \cm{theory ch} and perform
    experiments in collisions as detailed in \cm{how to cite collisions
    experiment?}. The magnetic transport
...
provided by drivers discussed in \cm{a later chapter.}
...
\begin{figure}[ht]
  ...
  \caption{
    % TODO see below
    \cm{Fix this caption to account for new iii and changed iv}
...
(see inset of \myfigref{design:fig:chipexperiment}).  The idea is to use this
...
similarly to other experiments such as \inlineref{Ott2001}.  Since it is under
...
We can investigate this with a simple example.  Consider two ideal quadrupoles
...
%
The simulation is presented in \mysubfigref{design:fig:uzsim}. We see that
...
pictured in \myfigref{design:fig:mttudetail}. Other than this, we see that
...
be seen in \mysubfigref{design:fig:zsim}{e}, the particles are highly localised
