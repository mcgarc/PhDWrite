...
\begin{figure}
  ...
  \centering
      \includegraphics[height=.6\textwidth]{figs/FlangeAssemblyForPresentationTopRight.png}
      \caption{}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
  \centering
      \includegraphics[height=.6\textwidth]{figs/fab/subchip1_cropped3.pdf}
      \caption{}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
  \centering
  \begin{overpic}[height=.6\textwidth,page=1]{figs/chip_des.pdf}
    \put(23,64){ \scalebox{.2}{\SI{100}{\micro\meter}}}
  \end{overpic}
      \caption{}
    \end{subfigure}
  \caption{
...
\thesis{This isn't really good enough. I need a cartoon of this phenomenom}.
