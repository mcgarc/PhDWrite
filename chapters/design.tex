...
the potential $V(t, \mathrm{q}) = \mu B(t, \mathrm{q})$, where $\mu$ is the
...
taken to be $\mathbf{v}$, so the change in volume is
%
\begin{equation}
...
Now consider the phase space density of the trap. This is defined as the
