...
in all three spatial dimensions with a standard deviation of $\simga_i$
(typically $\simga_i = \SI{1}{\milli\meter}$. Similarly the velocity components
...
\section{Compression in a Z-trap}
