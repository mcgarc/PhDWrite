...
\thesis{Will likely need more dicussion of transport in the thesis. For one
...
\cm{Need to fix this fig to put the chip on the right side of the chamber. But
...
than the wires on the chip. Since \ph{trap depth goes like some equation above,
this limits the depth of the trap.}
...
Hence it will be useful to have a series of Z wires on our chip. They will
...
(lower) trap, with $\mathrm{ZX}$ corresponding to the wire labels in
\mytableref{design:table:wires}.
