\cm{TODO: Should include more theory of the interaction stuff/ cavity QED
in this chapter. Intro should be something like:
%
...
%
I will now discuss the theory of interaction between molecules and microwaves
and the implementation of a coplanar waveguide on our chip.
%
}
...
\section{Theory of microwave--molecule interaction}

\cm{Check hyphenation of section title}
...
As discussed in \cm{chapter ??}, it is highly beneficial to be able to
...
\cm{Should replace this paragraph with some COMSOL simulation and further
...
\cm{I can combine these two theses into one reference. Probably a good idea,
...
\begin{figure}
  ...
  \caption{
    \cm{TODO: Redrawa myself and fix the labels (don't need $h_1$, just $h$,
    etc.}
...
\begin{figure}
  ...
  \caption{
    \cm{Redraw, fix permittivity labesl. Also need to think about quantum
    squeezing mode volume, as mentioned by Alex (somehow related to
    $(\lambda/n)^3$}
...
\cm{Throughout: need to figure out I vs we}
...
%
Wen demonstrated~\cite{1127105} that a conformal mapping \cm{expand} can be used
...
\end{align}
\cm{check that [Ohm] notation is ok}
