...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{figs/mws/sidebandcool.pdf}
  \caption{The sideband cooling scheme, with an external driving field applied to the
...
cryocooler temperatures of $T=\SI{4}{\kelvin}$. This corresponds to a background
photon number of
%
\begin{equation}
  m_\text{min} = \frac{k_B T}{\hbar \omega_0} = 25.
\end{equation}
%
The minimum temperature achievable by sideband cooling is therefore
\cm{This result, but not the above is for the MHz trap freq}
%
\begin{equation}
  T_\text{min} = \frac{\hbar \omega_t m_\text{min}}{k_B} = \SI{20}{\micro\kelvin}.
\end{equation}

This is a somewhat unsatisfying result, the 
