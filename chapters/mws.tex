...
The state of the molecule is now entangled with the state of the light so that
measuring the phase of the light will perform a readout of the molecule state.
This can be achieved, for example by a homodyne measurement.

% TODO Homodyne measurement for state readout discussion
