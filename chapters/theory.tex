...
\subsubsection{Electronic motion}
...
reason we are able to separate the wavefunction into electronic ($\psi_q$) and
nuclear ($\chi$) parts
%
\begin{equation}
  \psi = \sum_q \chi.
\end{equation}
%
Since the nuclei are stationary on this timescale, $\mathbf{R_{AB}}$ becomes a
parameter of $\psi_q$. The new TISE is
%
\begin{equation}
