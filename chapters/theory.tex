...
\begin{figure}[htb]
  ...
  \begin{subfigure}{0.4\textwidth}
      \centering
      \smallskip
      \includegraphics[width=\textwidth]{figs/theory/wires/dimple_margin.pdf}
  \end{subfigure} \\[3mm]
...
coordinates.
%
These terms represent the kinetic energy of the nuclei and the electrons
...
\begin{figure}
  ...
  \caption[Geometry of a diatomic molecule]{
    The geometry of a diatomic molecule, with relevant vectors labelled.
...
The wavefunction $\psi$ is a function of $\mathbf{R}_{AB}$ and the position of
each of the electrons, that is
%
\begin{equation}
...
in \inlineref{brown_carrington_2003}. The result allows us to separate to good
