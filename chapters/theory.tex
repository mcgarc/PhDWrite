...
coordinates.
%
The various terms represent the kinetic energy of the nuclei and the elctrons
in the COM frame, the various Coulomb attraction and repulsions, and the
so-called mass-polarisation term. This is the second term in
\myeqref{theory:eqn:mpterm}, and it accounts for small fluctuations in the COM
for the whole molecule relative to the COM of the nuclei.
%
