...
\end{equation}
%
as is shown in \cm{a figure}. The field close to the zero approximates a \cm{2D?} quadrupole field with
gradient
%
\cm{TODO.}
%
...
treat its contribution to the field as a perturbation. Such a configuration is
known as a dimple trap, and produces a field \cm{TODO equations}.

\cm{TODO: picture of dimple trap}
