...
couple to each other. They are pictured in \myfigref{theory:fig:hund}.

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figs/theory/hund2.pdf}
  \caption{Coupling schemes in Hund's (a) and (b) cases. In both, the 
  electronic coupling is strongest. In case (a) the spin-orbit coupling is
  stronger than the rotational, and the opposite is true in case (b). The
  $\mathbf{L}$ and $\mathbf{S}$ precesion are illustrated as an example by the dashed lines
  in (a), and only the former is shown in (b). Those vectors which precess
  around the internuclear axis provide quantum numbers assoicated to their
  projections onto this axis, that is $\Lambda$, $\Sigma$ and $\Omega$ in (a)
  and only $\Lambda$ in (b).
  }
...
$\mathbf{S}$ couples strongly to $L$. We therefore have good quantum numbers
...
\cm{This section is getting moved to microwaves.}
