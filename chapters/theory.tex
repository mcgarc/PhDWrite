...
direction ($\bm{\epsilon}$), $\mathbf{E} = E\bm{\epsilon}$. Note also that
we can write $s=I/I_s$.
...
trap, as shown in \mysubfigref{theory:fig:subdoppler}{b}. The polarisation
...
energy terms, except for the second term in \myeqref{theory:eqn:mpterm} which
...
nuclei. It is explained in more detail in \inlineref{brown_carrington_2003}.
%
...
dipole moment operator, and $\bm{\epsilon}$ as the vector representing the
