...
\newcommand{\thesis}[1]{} % TODO Scrub thesis comments and remove this line
\newcommand{\ph}[1]{\textcolor{purple}{#1}} % Placeholders
%\renewcommand{\cm}[1]{} % Uncomment to remove my comments
%\renewcommand{\mt}[1]{} % Uncomment to remove markers for thesis work
...
\newcommand{\inlinerefs}[1]{Ref.s~\cite{#1}}
\usepackage{datetime}
...
% Maybe superseeded by earlier theory?
}
